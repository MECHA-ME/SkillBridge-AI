  ...
  app.post("/api/resume/parse", async (req, res) => {
    try {
      ...
      if (!apiKey || apiKey === "undefined") {
        throw new Error("Missing GEMINI_API_KEY environment variable. Please check your project settings.");
      }
      ...
      if (errorMsg && errorMsg.includes("API key not valid")) {
        errorMsg = "The configured Gemini API key is invalid. Please update your GEMINI_API_KEY in the project settings.";
      }
